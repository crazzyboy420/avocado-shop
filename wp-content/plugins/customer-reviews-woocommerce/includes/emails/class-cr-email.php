...
class Ivole_Email {
	...
	public function trigger2( $order_id, $to = null, $schedule = false ) {
		...
		$result = $this->send_email( $data, $is_test );
		if( false === $result ) {
